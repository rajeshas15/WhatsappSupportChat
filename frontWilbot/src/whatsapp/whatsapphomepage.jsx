...
const chatList = [
  { id: 1, name: "WilAgent", message: "Welcome to WilAgent!", time: "", avatar: <FaUserCircle /> },
...
export default function WhatsAppHomePage() {
  ...
  const activeChat = chatList.find(chat => chat.id === Number(activeChatId));
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const res = await fetch("https://whatsappsupportchat.onrender.com/chat", {
        method: "POST",
